...
class Iphone extends JFrame implements ActionListener
{
	...
	Iphone(MobileDemo1 m)
    {
        md=m;
		ImageIcon i=new ImageIcon("C:\\JAVA PROGRAMS\\PROJECT\\Apple1.jpg");
        l1=new JLabel(i);
