...
class OnePlus extends JFrame implements ActionListener
{
    JLabel l1;
    JButton b1,b2;
    ...
    OnePlus(MobileDemo1 m)
    {
		this.setLayout(null);
        md=m;
		ImageIcon i=new ImageIcon("C:\\JAVA PROGRAMS\\PROJECT\\Onplus1.jpg");
        l1=new JLabel(i);
        ...
        ImageIcon i2=new ImageIcon("C:\\JAVA PROGRAMS\\PROJECT\\Next.jpg");
		b2=new JButton(i2);
        b2.setBounds(700,550,100,50);
        add(b2);
    ...
    public void actionPerformed(ActionEvent e)
    {
       ...
       {
			op1.setLayout(null);
			op1.setTitle("OnePlus");
			op1.setSize(1285,685);
			op1.setLocation(0,0);
			op1.setDefaultCloseOperation(EXIT_ON_CLOSE);
			this.setVisible(false);
            op1.setVisible(true);	        
       }
    } 
